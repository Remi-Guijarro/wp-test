...
Qode Essential Addons currently supports both Elementor and WPBakery page builder plugins. There are plans to expand the list of compatible page builder plugins in the future.

Apart from being compatible with all WordPress themes, the Qode Essential Addons plugin is a vital part of the first completely free theme designed by <a href="https://qodeinteractive.com" target="_blank">Qode Interactive</a>, the Qi Theme. Qode Essential Addons gives you even more when used with the Qi Theme; you get a large set of additional options, as well as a one-click import module. You can check out the theme and its huge selection of 100 diverse, fully developed modern website examples <a href="https://qodeinteractive.com/qi-theme/?utm_source=wordpress&utm_medium=org&utm_campaign=qi-addons" target="_blank">here</a>.
