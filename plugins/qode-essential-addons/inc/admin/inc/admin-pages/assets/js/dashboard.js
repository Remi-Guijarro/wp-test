(function ( $ ) {
	...
	var qodefWidgets = {
		...
		saveWidgetsValues: function ( $adminPage ) {
			this.widgetsForm = $adminPage.find( '#qode_essential_addons_widgets_framework_ajax_form' );
			...
			if ( this.widgetsForm.length ) {
				...
				this.widgetsForm.on(
					...
					function ( e ) {
						...
						var form          = $( this ),
							ajaxData      = {
								action: 'qode_essential_addons_action_framework_save_options'
						};
		...
		switchWidgetsValuesByControler: function ( $adminPage ) {
			this.optionsForm = $adminPage.find( '#qode_essential_addons_widgets_framework_ajax_form' );
