...
function ltheme_scripts() {
	...
	wp_enqueue_style( 'ltheme-fontawesome-font', '//fonts.googleapis.com/css?family=Rajdhani:300,regular,500,600,700&subset=latin-ext', array( 'ltheme-style' ), '20160816' );
	...
	wp_enqueue_script( 'particles-jquery', get_template_directory_uri() . '/js/particles.min.js', array( 'jquery' ), '20181230', true  );
	wp_enqueue_script( 'custom-particles-jquery', get_template_directory_uri() . '/js/particles.js', array( 'jquery' ), '20181230', true  );
...
function wpb_widgets_init() {
	...
	register_sidebar( array(
		 ...
		 'before_widget' => '<div class="top-head"">',
...
function gltheme_theme_customizer( $wp_customize ) {
	...
	*/
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://ltheme.com/project/lt-curico-free-responsive-bitcoin-wordpress-theme/" target="_blank" title="Get full website like demo with PRO version">' . __( 'Get PRO License', 'gltheme' ) . '</a>
